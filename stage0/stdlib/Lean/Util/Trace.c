...
lean_inc_n(v_toBind_2116_, 2);
v_toPure_2117_ = lean_ctor_get(v_toApplicative_2114_, 1);
lean_inc_n(v_toPure_2117_, 4);
...
lean_inc_n(v_optionName_2294_, 2);
...
lean_inc_n(v_currMacroScope_2620_, 3);
lean_inc_n(v_quotContext_2619_, 3);
...
lean_inc_n(v___y_2480_, 8);
lean_inc(v___y_2478_);
lean_inc_n(v___y_2489_, 29);
...
lean_inc_ref_n(v___y_2475_, 7);
lean_inc_ref_n(v___y_2477_, 7);
lean_inc_ref_n(v___y_2487_, 10);
...
lean_inc_ref_n(v_inst_3514_, 2);
lean_inc_n(v_toBind_3513_, 2);
...
lean_inc_ref_n(v_toApplicative_3552_, 2);
