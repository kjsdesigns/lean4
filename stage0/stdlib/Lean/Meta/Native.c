...
v___x_520_ = l_Lean_Option_get___at___00Lean_Meta_nativeEqTrue_spec__4(v___y_505_, v___y_504_);
...
v___x_629_ = l_Lean_Kernel_enableDiag(v_env_618_, v___y_611_);
