...
lean_inc_ref(v_toApplicative_1015_);
...
v___x_1065_ = lean_array_get_borrowed(v___x_1064_, v_declInfos_1005_, v___x_1054_);
...
v___x_3654_ = lean_array_get_borrowed(v___x_3653_, v_declInfos_3594_, v___x_3643_);
