...
lean_inc_ref(v_toApplicative_4380_);
...
lean_dec_ref(v_toApplicative_4380_);
...
v___x_4430_ = lean_array_get_borrowed(v___x_4429_, v_declInfos_4370_, v___x_4419_);
