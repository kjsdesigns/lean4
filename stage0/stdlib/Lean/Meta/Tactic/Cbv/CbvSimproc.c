...
v_k_679_ = lean_array_get(v___x_678_, v_keys_673_, v___x_676_);
...
v___x_2537_ = lean_array_get(v___x_2532_, v_es_2531_, v_j_2536_);
lean_dec(v_j_2536_);
lean_dec_ref(v_es_2531_);
