...
v___x_26053__overap_2366_ = lean_panic_fn_borrowed(v___x_2365_, v_msg_2308_);
...
v___x_940__overap_4513_ = lean_panic_fn_borrowed(v___x_4512_, v_msg_4457_);
