...
lean_ctor_set(v___x_128_, 1, v___y_97_);
lean_inc_ref(v___y_99_);
lean_inc_ref(v___y_95_);
v___x_129_ = lean_alloc_ctor(0, 5, 3);
lean_ctor_set(v___x_129_, 0, v___y_95_);
