...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "rel-2.1.2"
  WORKING_DIRECTORY "/home/runner/work/lean4/lean4/_codeql_build_dir/cadical/src/cadical"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("rel-2.1.2" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: rel-2.1.2")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/rel-2.1.2")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"rel-2.1.2\" is not present locally, and not "
